...
@IonicPage()
@Component({
    selector: 'page-activity-learning',
    templateUrl: 'activity-learning.html',
    providers: [UIHelper, CameraHelper]
})
export class ActivityLearningPage {
    ...
    constructor(public navCtrl: NavController,
        ...
        this.currentActivity = this.activityEnum.LEARNING;
    ...
    intilizeLearning() {
        ...
        this.learnings = this.activityType.ActivitySubType;
    ...
    setActivityDetails() {
        ...
        this.studentService.saveActivityDetails(this.studentActivity)
            .subscribe((result: ResponseModel) => {
                ...
                if (!!result) {
                    if (result.IsSuccess) {
                        this.UiHelper.showToast(Messages.LearningSaved, this.toast.SUCCESS);
                        this.goBack();
                    }
                    else {

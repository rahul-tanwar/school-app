...
@IonicPage()
@Component({
    selector: 'page-activity-potty',
    templateUrl: 'activity-potty.html',
    providers: [UIHelper, CameraHelper]
})
export class ActivityPottyPage {
    ...
    constructor(public navCtrl: NavController,
        ...
        this.currentActivity = this.activityEnum.POTTY;
    ...
    setActivityDetails() {
        ...
        this.studentService.saveActivityDetails(this.studentActivity)
            .subscribe((result: ResponseModel) => {
                ...
                if (!!result) {
                    if (result.IsSuccess) {
                        this.UiHelper.showToast(Messages.PottySaved, this.toast.SUCCESS);
                        this.goBack();
                    }
                    else {

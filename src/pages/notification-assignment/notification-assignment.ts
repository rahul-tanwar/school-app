...
@IonicPage()
@Component({
    selector: 'page-notification-assignment',
    templateUrl: 'notification-assignment.html',
    providers: [UIHelper, CameraHelper]
})
export class NotificationAssignmentPage {
    ...
    ionViewDidLoad() {
        ...
        this.notificationType = this.dataHelper.getNotificationTypeById(this.notificationTypeEnum.ASSIGNMENT, data);
